...
export class Host {
  ...
  private aiDetectionStates: Map<number, Map<string, boolean | Map<number, Map<number, string>>>> = new Map();
  ...
  private perimeterDetected(channel: number, perimeterType: string): Map<number, Map<number, string>> {
    const perimeterVal = this.aiDetectionStates.get(channel)?.get(perimeterType);
    return perimeterVal as Map<number, Map<number, string>>;
  }

  crosslineDetected(channel: number): Map<number, Map<number, string>> {
    return this.perimeterDetected(channel, 'crossline');
  }

  intrusionDetected(channel: number): Map<number, Map<number, string>> {
    return this.perimeterDetected(channel, 'intrusion');
  }

  loiteringDetected(channel: number): Map<number, Map<number, string>> {
    return this.perimeterDetected(channel, 'loitering');
  }

  forgottenDetected(channel: number): Map<number, Map<number, string>> {
    return this.perimeterDetected(channel, 'legacy');
  }

  takenDetected(channel: number): Map<number, Map<number, string>> {
  ...
  get _aiDetectionStates(): Map<number, Map<string, boolean | Map<number, Map<number, string>>>> {
